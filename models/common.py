...
class Conv(nn.Module):
    ...
    def forward(self, x):
        '''positive until here, (8,3,256,256) return into (8,48,128,128) with negative values '''
...
class DetectMultiBackend(nn.Module):
    ...
    def forward(self, im, augment=False, visualize=False, val=False):
        ...
        if self.pt:  # PyTorch
            y = self.model(im, augment=augment, visualize=visualize)[0] #source code withou index
